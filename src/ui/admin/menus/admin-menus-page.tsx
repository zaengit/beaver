...
import { MenuBuilder, type MenuTree } from "@zbeaver/beaver/ui/admin/menus/menu-builder"
...
export function AdminMenusPage() {
  ...
  const builderRef = useRef<import("@zbeaver/beaver/ui/admin/menus/menu-builder").MenuBuilderHandle>(null)
