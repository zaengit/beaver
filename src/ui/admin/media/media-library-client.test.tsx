...
import { MediaLibraryClient } from "@zbeaver/beaver/ui/admin/media/media-library-client"
...
vi.mock("@zbeaver/beaver/ui/admin/media/media-grid", () => ({
  MediaGrid: ({
    items,
    onSelect,
  }: {
...
vi.mock("@zbeaver/beaver/ui/admin/shared/media-upload-zone", () => ({
